...
from book.views import CategoryListView, BookListView,AuthorListView
from book import views
from book.auth import UserLoginAPIView,UserRegisterAPIView, UserLogoutAPIView
...
urlpatterns = [
    ...
    path('author/', AuthorListView.as_view(),name='Auther'),
